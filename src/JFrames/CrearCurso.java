...
public class CrearCurso extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        spn_horas.setModel(new javax.swing.SpinnerNumberModel(1, 1, null, 1));
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        ...
        int creditos = Integer.valueOf(spn_horas.getValue().toString());
        int horas = Integer.valueOf(spn_creditos.getValue().toString());
        JOptionPane.showMessageDialog(rootPane, creditos+","+horas);
        String codigo = String.valueOf(datos.numCursos);
        if (!nombre.isEmpty()) {
            Curso nuevo = new Curso(codigo,nombre,creditos,horas);
            datos.numCursos++;
            JOptionPane.showMessageDialog(rootPane, "Usuario registrado con Exito");
            datos.cursos.add(nuevo);
        }else{
            
            JOptionPane.showMessageDialog(rootPane, "Especifique el nombre");
        }
